...
export function Dropdown(props: { items: string[], prop: string, id: number, order: boolean }) {
    const items: string[] = props.items == undefined || props.items.length <= 1 ? ["Bitte wählen"] : props.items;
